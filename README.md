...
```
## 0. `なぜ` が未記入の決定（冒頭で確認）
| DEC-013 | 全社展開に向けた構成見直しは今回のスコープに含めない | 顧客PM | 2026-09-11 |
...
## 1. 前回からの未完了アクション
| ACT-011 | 図面PDF対応の追加見積を提示する | 2026-09-18 | **超過** |
```

- 理由が未記入の決定、期限を過ぎたアクション、長く止まっている未決の問いが、自動で並ぶ
- Stop フックがターンの終わりに `views/agenda-next.md` を作り直すので、頼み忘れても最新版がある
